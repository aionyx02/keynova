...
//   4. `modeRef === "terminal"`       → exit terminal back to launcher input.
//   5. `cmdResultRef !== null`        → unwind command result + pipeline.
//   6. `queryRef !== ""`              → clear typed query only.
//   7. otherwise                      → hide launcher window.
